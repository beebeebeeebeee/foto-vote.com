  ...
  data.data.forEach((element, index) => {
    ...
    temp1 += `
        <div class="card" style="margin-bottom: 10px">
            ...
            <img src="/static/hash/images/${element.element}" style="width: 100%"></img>
            <div class="card-body" style="padding: 0.5rem;">
                <div class="progress" style="height: 20px; width: 100%; margin-top: 5px;">
                    ...
                    <div class="progress-bar bg-info" role="progressbar" style="width: ${Math.round(element.vote_ab.ok/element.length*100)}%" aria-valuenow="${Math.round(element.vote_ab.ok/element.length*100)}" aria-valuemin="0" aria-valuemax="100">${element.vote_ab.ok} OKAY</div>
